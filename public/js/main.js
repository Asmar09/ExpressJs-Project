...
const getInfo = async(event) =>{
    ...
    if(cityVal === ""){
        ...
        try{
        let url = `http://api.openweathermap.org/data/2.5/weather?q=${cityVal}&appid=ae441e829983993fdf78fa467996747e`;
  ...
  temp_real_val.innerText = arrData[0].main.temp;
       ...
       tempMood = arrData[0].weather[0].main;
         ...
         if(tempMood === "Clear"){
            ...
            temp_status.innerHTML = "<i  class='fas fa-smog' style='color: #ccc;'></i> ";
         }else{
            temp_status.innerHTML = "<i  class='fas fa-sun' style='color: #eccc68;'></i> ";
